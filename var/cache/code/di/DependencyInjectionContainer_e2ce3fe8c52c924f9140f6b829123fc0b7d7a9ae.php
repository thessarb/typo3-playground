 ...
 * @final
 */
class DependencyInjectionContainer_e2ce3fe8c52c924f9140f6b829123fc0b7d7a9ae extends Container
{
    private $parameters = [];
    private $getService;
    ...
    protected function getCommandRegistryDecorated1Service()
    {
        ...
        $a->addLazyCommand('mask:convert', 'MASK\\Mask\\Command\\ConvertFormatCommand', false);
    ...
    {
        $a = ($this->privates['TYPO3\\CMS\\Core\\Database\\ConnectionPool'] ?? ($this->privates['TYPO3\\CMS\\Core\\Database\\ConnectionPool'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Core\Database\ConnectionPool::class)));
    ...
    protected function getFormPersistenceManagerService()
    {
        ...
        $instance->injectYamlSource(($this->privates['TYPO3\\CMS\\Form\\Mvc\\Configuration\\YamlSource'] ?? $this->getYamlSourceService()));
        $instance->injectStorageRepository(($this->services['TYPO3\\CMS\\Core\\Resource\\StorageRepository'] ?? $this->getStorageRepository2Service()));
        $instance->injectFilePersistenceSlot(($this->services['TYPO3\\CMS\\Form\\Slot\\FilePersistenceSlot'] ?? ($this->services['TYPO3\\CMS\\Form\\Slot\\FilePersistenceSlot'] = \TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Form\Slot\FilePersistenceSlot::class))));
        $instance->injectResourceFactory(($this->services['TYPO3\\CMS\\Core\\Resource\\ResourceFactory'] ?? $this->getResourceFactoryService()));
        $instance->initializeObject();
    ...
    {
        return $this->privates['extensionconfiguration.mask'] = (\TYPO3\CMS\Core\Utility\GeneralUtility::makeInstanceForDi(\TYPO3\CMS\Core\Configuration\ExtensionConfiguration::class))->get('mask');
    }
}
